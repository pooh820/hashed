                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="password" placeholder="輸入密碼" required>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="password">密碼</label>
                            <input type="text" class="form-control" id="password2" placeholder="輸入密碼" required>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <table id='userTable' class='display dataTable' width='100%'>
            <thead>
                <tr>
                    ...
                    <th bgcolor="#99BBFF" scope="col">密碼</th>
